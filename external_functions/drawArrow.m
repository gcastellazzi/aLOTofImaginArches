function [hArrow] = drawArrow( gca , p0, p1, color)
% drawArrow(p0,p1)
%
...
% Parameters:
W1 = 0.04;   % half width of the arrow head, normalized by length of arrow
W2 = 0.007;  % half width of the arrow shaft
L1 = 0.09;   % Length of the arrow head, normalized by length of arrow
L2 = 0.06;  % Length of the arrow inset
...
% Plot!
hArrow = patch(gca , P(1,:), P(2,:),color); % axis equal;
